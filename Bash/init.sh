...
sed -i 's/127\.0\.0\.1/0\.0\.0\.0/g' /etc/mysql/mysql.conf.d/mysqld.cnf
          ...
          echo "CREATE USER 'vpn'@'localhost' IDENTIFIED BY 'localhostvpnpasswd';" >>  /tmp/init.sql
          ...
          echo "CREATE USER 'vpn'@'127.0.0.1' IDENTIFIED BY 'localhostvpnpasswd';" >>  /tmp/init.sql
