...
L2TP_NET=${VPN_L2TP_NET:-'10.168.0.0/16'}
L2TP_LOCAL=${VPN_L2TP_LOCAL:-'10.168.0.1'}
L2TP_POOL=${VPN_L2TP_POOL:-'10.168.0.10-10.168.245.250'}
XAUTH_NET=${VPN_XAUTH_NET:-'10.169.0.0/16'}
XAUTH_POOL=${VPN_XAUTH_POOL:-'10.169.0.10-10.169.245.250'}
...
Myazure.org--WangZhen--Make&install
